...
public class SubmitActivity extends AppCompatActivity implements OnItemSelectedListener {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(SubmitActivity.this, "hello", Toast.LENGTH_LONG).show();
                        }
                    });
                } else {
